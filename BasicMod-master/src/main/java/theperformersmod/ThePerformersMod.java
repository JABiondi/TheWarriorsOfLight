...
public class ThePerformersMod implements
    ...
    public static void initialize() {
        new ThePerformersMod();

        ThePerformers.Meta.registerColor();
    }

    public ThePerformersMod() {
    ...
    private static String checkResourcesPath() {
        String name = ThePerformersMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                ...
                "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                "\tat the top of the " + ThePerformersMod.class.getSimpleName() + " java file.");
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(ThePerformersMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
