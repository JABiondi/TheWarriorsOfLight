package theperformersmod.character;
...
import static theperformersmod.ThePerformersMod.characterPath;
import static theperformersmod.ThePerformersMod.makeID;

public class ThePerformers extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Performers"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass PERFORMERS;
        @SpireEnum(name = "PERFORMERS_YELLOW_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "PERFORMERS_YELLOW_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;

        //Character select images
        private static final String CHAR_SELECT_BUTTON = characterPath("select/theperformersbutton.png");
        private static final String CHAR_SELECT_PORTRAIT = characterPath("select/theperformersportrait.png");
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new ThePerformers(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public ThePerformers() {
        // TODO: COMMENTED CODE IS FOR ANIMATIONS. SNIPPET BELOW DISPLAYS A STATIC IMAGE INSTEAD
//        super(getNames()[0], Meta.THE_PERFORMERS,
...
//    }
        // TODO: THIS CODE DISPLAYS STATIC IMAGE OF CHARACTER
        super(getNames()[0], Meta.PERFORMERS,
                new CustomEnergyOrb(orbTextures, characterPath("energyorb/vfx.png"), layerSpeeds), //Energy Orb
