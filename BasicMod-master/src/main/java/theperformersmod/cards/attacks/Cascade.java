...
public class Cascade extends BaseCard {
    public static final String ID = makeID(Cascade.class.getSimpleName()); // unique label for card. Turns CLASS name into card ID
