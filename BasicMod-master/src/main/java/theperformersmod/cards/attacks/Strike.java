...
public class Strike extends BaseCard {
    public static final String ID = makeID(Strike.class.getSimpleName()); // unique label for card. Turns CLASS name into card ID
    ...
    public Strike() {
        ...
        tags.add(CardTags.STARTER_STRIKE); // Used by pandoras box
        tags.add(CardTags.STRIKE); // Used by strike dummy / perfected strike
    }
