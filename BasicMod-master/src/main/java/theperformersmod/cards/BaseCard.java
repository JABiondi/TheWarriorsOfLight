package theperformersmod.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import theperformersmod.ThePerformersMod;
import theperformersmod.util.CardStats;
import theperformersmod.util.TriFunction;
...
import static theperformersmod.util.GeneralUtils.removePrefix;
import static theperformersmod.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return ThePerformersMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    ThePerformersMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
